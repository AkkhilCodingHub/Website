...
const Profile: React.FC<{ student: Student }> = ({ student }) => {
  ...
  return (
    <div className="profile-container w-full h-full fixed top-0 left-0 bg-cover bg-[url('/image.jpeg')] px-4 py-8 bg-white rounded-md shadow-md">
      <h1>{student.name}</h1>
      <p className="text-gray-500 mb-2">Roll Number: {student.rollno}</p>
